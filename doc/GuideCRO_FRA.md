...
Le format CPR a été construit à partir d'une méthode standard appelée "RIFF". Il est cependant trop simpliste car les roms ne possèdent aucune propriété (taille, type) . Et ceci se révèle problématique.  
